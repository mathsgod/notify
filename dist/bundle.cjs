...
var require_env = __commonJS({
  "src/env.js"(exports2, module2) {
    ...
    module2.exports = { resolveEnv };
  }
});

// src/channels/email.js
var require_email = __commonJS({
  "src/channels/email.js"(exports2, module2) {
    var nodemailer = require_nodemailer();
    var { resolveEnv } = require_env();
...
var require_slack = __commonJS({
  "src/channels/slack.js"(exports2, module2) {
...
var require_gmail = __commonJS({
  "src/channels/gmail.js"(exports2, module2) {
    var nodemailer = require_nodemailer();
    var { resolveEnv } = require_env();
...
`);
        config.checks.forEach((check, i) => {
          ...
          console.log(`     Condition: ${c.field ? c.field + "." : ""}${c.operator || "truthy"} ${c.value !== void 0 ? c.value : ""}`);
...
var require_channels = __commonJS({
  "src/channels.js"(exports2, module2) {
    var { loadConfig } = require_config();
    ...
    function register(program2) {
      const channelsCmd2 = program2.command("channels").description("Manage notification channels");
      channelsCmd2.command("list").description("List all configured channels").option("-c, --config <path>", "path to config file", "notify.json").action((options) => {
        const config = loadConfig(options.config);
...
var runCmd = require_run();
var checksCmd = require_checks();
var channelsCmd = require_channels();
var program = new Command();
program.name("notify").description("Monitor endpoints and send email notifications based on conditions").version("1.0.0");
